...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1;">
    <p>
      <strong><a href="https://github.com/Toheedullah-K3/contact-management-system">Connectify</a></strong><br>
      <em>Description:</em> Connectify is a robust contact management system designed to streamline the way users organize and manage their contacts. Built on the MERN stack, it leverages React for a dynamic user interface, Express.js and Node.js for scalable backend services, and MongoDB for efficient data storage. This project incorporates advanced CRUD operations, real-time data synchronization, and user authentication features to ensure a seamless user experience.
    </p>
    <p>
      <strong><a href="https://github.com/Toheedullah-K3/car-connect">CarConnect</a></strong><br>
      <em>Description:</em> CarConnect is an advanced showroom management system engineered to optimize showroom operations. Utilizing the MERN stack, the application features a high-performance backend with Node.js and Express.js, paired with a responsive React frontend. CarConnect offers comprehensive vehicle inventory management, customer relationship tracking, and integrated analytics, all powered by a MongoDB database. This project exemplifies modern web development practices, including state management, API integration, and modular architecture.
    </p>
  </div>
